...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  Color color() const { return static_cast<Color>(GetField<int8_t>(16, 3)); }
...
struct MonsterBuilder {
  ...
  void add_color(Color color) { fbb_.AddElement<int8_t>(16, static_cast<int8_t>(color), 3); }
...
inline bool VerifyMonsterBuffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<MyGame::Monster>(); }
