        ...
        if self._last_value:
            for proc_id in current[u'processes']:
                if proc_id in self._last_value[u'processes']:
                    ...
                    for key in [u'read_ios', u'write_ios', u'read_bytes', u'write_bytes', u'cpu_user', u'cpu_system', u'num_ctx_switches_voluntary', u'num_ctx_switches_involuntary']:
...
if __name__ == '__main__':
    ...
    def loop():
        ...
        #pprint(res)
        if res:
            print(len(res[u'processes']), res[u'last_period'], res[u'command_duration'])
        else:
            print("first is None")
